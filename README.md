...
Per-app VPN bypass for Throne on Omarchy: свой sing-box с TUN отправляет выбранные приложения напрямую, остальное — в локальный SOCKS Throne, а nftables-guard не даёт трафику уйти в интернет мимо VPN и исключений. Что и почему — в `CONTEXT.md` и `DESIGN.md`.
